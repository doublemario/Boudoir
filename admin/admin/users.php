...
if(!empty($_POST)){
    ...
    if(!isset($post['password']) OR strlen($post['password']) <= 5 OR $post['password'] !== $post['password2']){
        $errors['password'] = 'le mot de passe doit faire au moins 5 caractères et/ou les mots de passe doivent être identiques';
    }
...
<ul>
    <li><a href="#">Home</a></li>
    <li><a href="#">Ajouter une boutiques</a></li>
    ...
    <div class="row">
        <div class="col-md-12" id="shadow2">
            ...
            <form method="post">
                ...
                <button type="submit" class="btn btn-lg btn-block" id="bouton">Ajouter</button>
            </form>
        </div>
    </div>
    <br>
    ...
    <div class="row justify-content-between">
        <ul class="list-group">
            ...
            foreach ($vendeurs as $vendeur){
                ?>
                <li class="list-group-item" id="shadow3">
                    <?= $vendeur['nom'] ?>
        ...
        <ul class="list-group">
            ...
            foreach ($vendeurs as $vendeur){
                ?>
                <li class="list-group-item" id="shadow4">
                    <?= $vendeur['nom'] ?>
